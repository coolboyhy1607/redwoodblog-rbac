...
export default class AuthStore {
  @observable
  user: (User | null | undefined) | "guest";
  @observable
  team: (Team | null | undefined) | "guestTeam";
  @observable
  ...
  constructor(rootStore: RootStore) {
    ...
    } catch (_) {// no-op Safari private mode
    }
    ...
    window.addEventListener("storage", event => {
      if (event.key === AUTH_STORE) {
        const data: PersistedData | null | undefined = JSON.parse(event.newValue);
